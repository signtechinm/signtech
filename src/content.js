export const defaultContent = {
  ...
  home: {
    ...
    headline: "Digital solutions for businesses ready to grow online.",
  ...
  intro: {
    ...
    headline: "Expert IT consulting, from idea to execution.",
    body: "We help businesses make the right technology decisions, improve performance, strengthen security, and turn digital transformation into practical outcomes.",
  },
  services: [
    {
      title: "Web Apps",
  ...
  about: {
    eyebrow: "Introduction to Signtech",
  ...
  mission: {
    ...
    missionBody: "We drive growth, enhance engagement, and streamline operations.",
    visionHeadline: "Become a leading digital partner for brands worldwide.",
    visionBody: "Known for excellence, integrity, and long-term value creation.",
  },
  values: [
    ["Innovation", "Embracing technology to create forward-thinking solutions."],
    ["Integrity", "Building trust through transparency and consistency."],
    ["Customer Focus", "Placing clients at the heart of everything we do."],
    ["Quality", "Delivering excellence in every line of code and every pixel."],
  ],
  tech: [
    ...
    ["WooCommerce", "/assets/woo.png"],
  ],
  partners: {
    eyebrow: "Trusted by associates and partners",
    headline: "Strengthening innovation through collaboration.",
    body: "Our network of trusted partners helps us deliver broader capabilities, high-quality solutions, and dependable service for every client.",
    image: "/assets/partner-growth.png",
  },
  contact: {
    eyebrow: "Contact sales",
    headline: "Looking for a scalable and user-friendly digital solution?",
    body: "Tell us what you want to build. We will shape the right mix of design, development, marketing, and integrations for your business.",
  },
};

export function mergeContent(remoteContent) {
  return {
    ...defaultContent,
    ...remoteContent,
    settings: {
